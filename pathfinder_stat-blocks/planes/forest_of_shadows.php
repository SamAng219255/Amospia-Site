...
/mm/Spells with the light descriptor or that use or generate light or fire are impeded on the Shadow Plane. Spells that produce light are less effective in general, because all light sources have their ranges halved on the Shadow Plane.')
			],
			[
...
/mm/Mirrors to the races of the material plane, the various races of Shadows appear in every way identical to the races they mirror except that appear to be completely grayscale, they see light as darkness and darkness light seeing colors where others see grays and gestures where others see colors, and that their souls are composed of negative energy instead of positive energy like almost all other souls in the planes.
