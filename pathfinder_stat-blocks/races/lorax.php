...
<?php
	raceBlockAuto(
		...
		"Lo'raks are mostly humanoid with an exoskeleton of gray bark protecting them. Beneath the bark is a yellow-white flesh simialr to plant stems. Lo'raks have a wide build but move with a surprising grace.",
		...
		"Lo'raks boast incredible strength while remaining quite nimble. Lo'raks are also quite hardy, able to withstand many blows, though their intelligence leaves something to be desired with most simply following orders without a second thought.",
		[
			...
			"Necromantic Sight: Using anti-undead necromantic magic, Lo'raks have been given the ability to sense undead. All Lo'raks are treated as though effected by a continuous ii/detect undead/ii spell.",
