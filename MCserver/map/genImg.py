...
exclusions=[390,517,81,455,456,77,64,265,869,1298,759,780,468,153,157,172,398,406,417,422,423,424,795,921,922,1410,2129,2164,1426,1425,1433,920,919,69,2264,19,13,620,2621,5,353,2400]
pictures=[1349]
...
if __name__=='__main__':
	...
	if not modeHlp:
		...
		print("Syntax:",
			...
			"s - Only Update A Specified Tile Which Is Specified Using The 'timeKey' Parameter",
