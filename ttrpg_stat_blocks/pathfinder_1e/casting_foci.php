...
<?php
	block(
		...
		quick_format([
			...
			'All casting foci can be enchanted like a magic weapon. Enhancement bonuses add to any attack rolls or save DCs associated with the spell. Melee weapon properties only apply to damaging spells with a range of touch, while ranged weapon properties only apply to damaging spells with a range longer than touch and that are a "ray" effect or that have a target or targets. Weapon properties with additional restrictions cannot be applied to casting foci. Certain exceptions do apply however. If a casting focus is enchanted with ii/ghost touch/ii all spells cast with it are unaffected by the incorporeal quality as per ii/ghost touch/ii. A casting focus can be enchanted with the ii/deadly/ii property which changes any non-lethal damage dealt by spells cast with the focus to lethal damage instead but also makes every spell cast with the focus count as a "damaging" spell. If a casting focus is enchanted with the ii/keen/ii quality or is the subject of the ii/keen edge/ii spell, it doubles the threat range of all attack rolls associated with spells cast using the focus. An enchanted casting foci has the higher caster level of its base caster level and the caster level of its enchantments.',
