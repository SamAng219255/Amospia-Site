<?php 
	...
	block(
		...
		quick_array([
			...
			'As this descriptor is designed to be applied to existing canon spells retroactively, the following is a list of spells that gain the destruction descriptor. This list is incomplete and I will add to it as I determine additional spells. Spells marked with * are spells designed by me and can be found on this site under aa/spells|spells/aa. These spells do have destruction listed as one of their descriptors. Spells marked with ** are third-party spells not designed by me.'
		])
	);
?>
<ul>
