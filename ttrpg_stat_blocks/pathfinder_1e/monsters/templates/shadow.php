<?php 
	...
	block(
		...
		quick_array([
			...
			'Shadows are more prone to finding decay, rot, and the natural march of entropy beautiful than where nature has created something. Shadows also have less of an affinity with creation magic than the norm treating their caster level as 2 less when casting a spell of the creation subschool and treating their caster level as 2 higher when casting a spell that specifically deals damage to inanimate objects or that dispell or otherwise destroy an effect. They also receive a -5 penalty to craft skills and an untyped +5 bonus to their CMB on sunder attempts.'
		]),
		true
	);
