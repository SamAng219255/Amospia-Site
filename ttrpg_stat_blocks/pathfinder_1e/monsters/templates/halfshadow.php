<?php 
	...
	block(
		...
		quick_array([
			...
			'Half-shadows are more prone to finding decay, rot, and the natural march of entropy beautiful than where nature has created something. Half-shadows also have less of an affinity with creation magic than the norm and a stronger one with magic that destroys objects, treating their caster level as 2 less when casting a spell of the creation subschool and treating their caster level as 2 higher when casting a spell of the aa/destruction_school|destruction/aa pseudo-subschool. They also receive a -5 penalty to craft skills and an untyped +5 bonus to aa/deconstruction|deconstruction/aa skills, though the penalty to craft skills cannot reduce their result below 1.'
		]),
		true
	);
