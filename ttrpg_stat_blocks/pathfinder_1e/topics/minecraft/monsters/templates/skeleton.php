...
<?php
	block(
		...
		quick_array([
			...
			'ii/Sunlight Flammability/ii (Ex): When exposed to direct sunlight, skeletons burst into flame and take 1 point of fire damage per hit dice every round until they die. At which point their body burns to ash and is completely destroyed. If the skeleton gets out of the sunlight before it dies, it is still on fire and will continue to take 1d6 points of fire damage, to a maximum of its number of hit dice, each round until it is extinguished.',
			...
			'bb/Abilities/bb: A skeleton’s Dexterity increases by +2. It has no Constitution or Intelligence score. If a skeleton possesses class levels requiring an intelligence or constitution score, use the skeleton\'s charisma score and increase it to the associated score of the base creature if it is greater.',
		...
		[
			[
				...
				'texts' => quick_array([
					...
					'bb/Abilities/bb: A skeleton’s Dexterity and Charisma increase by +2. It has no Constitution score. If a skeleton possesses class levels requiring a constitution score, use the skeleton\'s charisma score and increases it to the constitution score of the base creature if it is greater, before increasing it by 2. A wither skeleton cannot have a charisma of less than 14.',
			...
			[
				...
				'spaced' => true,
				'texts' => quick_array([
					'Native to icy wasteleands, these skeletons are infused with the land\'s chill.',
					...
					'bb/Weaknesses/bb: Strays retain all of the weaknesses of skeletonsbut also gain vulnerability to fire.',
					...
					'ii/Freezing Strike/ii (Su): All melee attacks by the stray deal an additional 1d6 points of cold damage. If the target takes at least 1 point of cold damage from the Stray\'s melee attack it is subjected to the effects of the ii/icy prison/ii spell with a DC equal to 10 plus the stray\'s new CR.',
