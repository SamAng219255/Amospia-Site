...
<?php
	raceBlockAuto(
		...
		[
			...
			"Languages: Illagers begin play speaking Common. Illagers with high Intelligence scores can choose from the following languages: Abyssal, Aklo, Dwarven, Elven, Gnoll, Infernal, and Orcish."
		],
		false
	);
