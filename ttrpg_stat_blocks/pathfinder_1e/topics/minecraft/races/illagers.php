...
<?php
	raceBlockAuto(
		'Illager',
		10,
		'Illagers are the violent cousins of the villager, opposite in almost every way. Illagers prefer live in massive mansions surrounded by the finest commodities they can get their hands on and are known to make deals with many fiends to get that.',
		'Illagers are almost identical to villager with the excpetions of their comletely gray skin and bushy dark gray eyebrows replacing the villager\'s common unibrow.',
		...
		[
			...
			'Hatred: While Illagers hate all other races, the illagers have a particular hatred for their human and villager cousins. Illagers have a +1 racial bonus on attack rolls against humans and villager.',
			...
			'Languages: Illagers begin play speaking Illager. Illagers with high Intelligence scores can choose from the following languages: Abyssal, Aklo, Common, Infernal, and Villager.'
		],
		false
	);
