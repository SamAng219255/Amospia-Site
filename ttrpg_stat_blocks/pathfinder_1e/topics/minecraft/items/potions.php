<?php 
	...
	magicItemBlockAuto(
		...
		'—',// Weight
		'The drinker of this potion receives 1d3 points of nonlethal poison damage per level of the potion each round for 1 minute or 2 minutes if extended. Splash versions of this potions only cost twice the regular price and lingering potions cost four times the listed price.',// Desc
		false,// Is Artifact
