<?php 
	...
	surgeBlock(
		'Lightweaving', // name
		'Illumination', // surge
		'close (25 ft. + 25 ft./level) or 5 ft.; see text', // range
		false, // target=false
		'visual figment that cannot extend beyond four 10-ft. cubes + one 10-ft. cube/level (S)', // effect=false
		false, // area=false
		10, // cost
		'1 minute', // interval
		true, // dismiss
		[
			...
			'Lightweaving can also create an illusion that is tied to the surgebinder, making it move with them. While doing so, the surgebinder does not leak stormlight and does not shed light as what would otherwise be escaping or remaining on the surface is instead whisked into the illusion to continue to feed it.',
			'At the first level at which it is available, a surgebinder can use lightweaving to replicate the effects of ii/disguise self/ii except as noted in this description.',
			'At the third level at which it is available, a surgebinder can use lightweaving to replicate the effects of ii/mirror image/ii except as noted in this description.',
			'At the fifth level at which it is available, a surgebinder can use lightweaving to replicate the effects of ii/adjustable disguise/ii except as noted in this description.',
			...
			'Any given illusion created by lightweaving can, as a free action, be converted to any other type of illusion which it matches the appearance and range of. Potentially creating an effect wherein there are multiple images of creatures of the same type as the surgebinder with 5 feet of the surgebinder where at any given time any number of them are replicating the actions of the surgebinder while others remain still or walk around as directed using move actions.'
		]  // desc
	);
