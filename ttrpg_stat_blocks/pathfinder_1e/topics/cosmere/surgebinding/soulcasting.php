<?php 
	...
	surgeBlock(
		...
		'Altered Ones, Elsecallers, Lightweavers', // access
		'Touch', // range
		...
		[
			...
			'Successful soulcasting requires making a Diplomacy check equal to 20 plus 3 per step of difficulty. A radiant surgebinder receives a +4 bonus to this check for each ideal they have obtained. Up to 20 additional points of investiture may be given to the representation of the object in order to gain a bonus equal to the number of points of investiture. This cost is not reduced by the knight radiant\'s stormlight efficiency.',
			'In order to enable the cognitive representation to undergo the transformation, it must be infused with at least 20 points of investiture. This amount is affected by a radiant surgebinder\'s stormlight efficiency.',
