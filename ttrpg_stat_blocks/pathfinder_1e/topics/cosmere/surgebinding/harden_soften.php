<?php 
	...
	surgeBlock(
		'Harden/Soften', // name
		'Tension', // surge
		'Focused Ones, Stonewards', // access
		'Touch', // range
		'one object or a group of similar or connected objects', // target=false
		false, // effect=false
		false, // area=false
		'10; see text', // cost
		'1 minute', // interval
		...
		[
			...
			'This ability can also be used on a collection of similar or connected objects, such as the different plates of a set of armor or the many bands of a focused one\'s wrapping, so long as the objects remain in contact with one another. Use the total occupied volume of objects, rounded up, for determining the cost of investiture.',
