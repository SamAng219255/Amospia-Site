<?php 
	...
	allomancy(
		...
		[
			10 => [
				'effect' => 'The misting may name one spell or effect to not dispel on the target. When doing so, the misting must make another caster level check vs the dispel check. If it succeeds the named spell is skipped when determining which effects are dispelled.',
				'draw' => ''
			],
			20 => [
