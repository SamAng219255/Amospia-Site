<?php 
	...
	feruchemy(
		...
		'1 round',
		[
			'The skimmer can store and tap weight. When storing or tapping weight, their weight is decreased or increased and they count as a smaller or larger size category in every way except that their actual size does not change. This means that the skimmer takes up the same space as they did before and their reach does not change. In addition, while storing or tapping weight, weapons wielded whose side is closer to the skimmer\'s actual size than their equivalent size is have their damage increased, while tapping, or decreased, while storing, by a number of steps equal to the difference in the size of the weapon and skimmer\'s equivalent size category. This ability does not otherwise change the skimmer\'s ability to wield weapons of a given size.',
