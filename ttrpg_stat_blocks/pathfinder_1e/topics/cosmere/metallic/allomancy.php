<?php 
	...
	block(
		...
		quick_array([
			...
			'Most metals grant a passive effect that is treated as a spell-like ability that lasts as long as you burn the metal. Others grant access to one or more spell-like abilities you can use while burning the metal and a few grant both. These abilities are subject to spell resistance and do not provoke attacks of opportunity unless stated otherwise and dispelling the passive effect of a metal being burned also makes the allomancer stop burning that metal. The spell level of these abilities are dynamic and are both determined by the ability that grants the allomancy and can be increased by various effects. The allomancer\'s caster level for these abilities is treated being twice their spell level.',
			...
			'Metal which intersects a living person\'s body is immune to allomancy effects below level 7.'
		]),
		true,
		[
			[
