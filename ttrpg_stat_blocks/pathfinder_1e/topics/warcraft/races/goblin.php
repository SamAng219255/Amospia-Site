<?php 
	...
	raceBlockAuto(
		...
		[
			...
			'bb/Medium/bb: Goblins are Small creatures and gain a +1 size bonus to their AC, a +1 size bonus on attack rolls, a –1 penalty on combat maneuver checks and to their Combat Maneuver Defense, and a +4 size bonus on Stealth checks.',
			...
			'bb/Languages/bb: Goblins begin play speaking Orcish. Goblins with high Intelligence scores can choose from Common, Goblin, Gutterspeak, Shalassian, Taur-ahe, Thalassian, and Zandali.'
		],
		false,
		[
			[
	...
	racialFeats('goblin', [
		[
			...
			'benefit' => 'This feat is similar to the Leadership feat, with several exceptions. You can attract only a 1st-level cohort (referred to hereafter as a pack hobgoblin) with this feat, and can\'t recruit followers. You determine your Leadership score according to the rules presented in the Leadership feat, but your pack hobgoblin is always at least 3 levels lower than yourself.  A pack hobgoblin must be a goblin and can only take levels in fighter with the pack mule archetype. They cannot multiclass.
