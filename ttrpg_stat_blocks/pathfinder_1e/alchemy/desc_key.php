		...
		[
			...
			[
				...
				'texts' => quick_array([
					...
					'/m2/ bb/Cell/bb: Cells are activated items that are generally thrown at a target as part of activating the item. Hitting a target with a cell requires making thrown weapon attack, with a range increment of 20 feet and maximum range of 100 feet, against the target\'s touch AC. On a miss a cell lands 5 feet away in a random direction plus an additional 5 feet for every full range increment to the target. On a hit, the target is automatically subject to the cell, though they can still make any asociated saves. Any other creatures in the square where the cell lands have a 50% chance of also being targetted by the cell\'s effect.',
					'/m2/ Some cells can also be used in melee and, when used as such, require a melee touch attack to target the creature instead. Whether the attack hit, every other creature in the target\'s square has a 50% chance of being in the effect in which case they may make an additional Reflex save against the effect in addition to any saves the effect allows.',
					'/mm/ /ee/ <h4>Applied</h4>',
					'/mm/ Applied recipes are designed to applied to a surface and may be designed to activate any properties when exposed to the intended surface or to air or moisture. Applied recipes could mimic aa/alchemical_oils|alchemical oils/aa, make surfaces slippery, or transmute one substance to another. Unless specified otherwise, application recipes yield a substance that can be applied to a surface or object later as a standard action that provokes attacks of opportunity.',
					'/mm/ /ee/ <h4>Bomb</h4>',
					...
					'/mm/ bb/ ii/Sub-Forms/ii /bb',
					'/m2/ bb/Transmutation/bb: Transmutation recipes convert one object into another instead of fully creating a new object. Transmutation recipes always include an exceptional reagent that is transmuted into the product.',
					'/mm/ /ee/ <h4>Imbibed</h4>',
					'/mm/ Imbibed recipes are generally designed to be drunk and have a specific effect created by interacting with the imbiber\'s biology. Imbibed recipes yield a consumable substance that can be eaten, or more often drank, later to provide their effect. Consuming an imbibed recipe is a standard action that provokes attacks of opportunity. Due to their reliance on the target creatures biology, imbibed recipes have no effect on constructs or elementals and the creator must make an alchemy level check for the recipe to affect undead or aberrations with a DC equal to 11 plus their CR unless it was created by the same type of undead or aberration. Creatures immune to poison are also immune to the harmful effects of imbibed recipes. Creatures that are unable to eat or drink (as opposed to ones that don\'t need to) are incapable of consuming an imbibed recipe. A creature can administer an imbibed recipe to a willing or helpless creature.',
					'/mm/ bb/ ii/Sub-Forms/ii /bb',
					'/m2/ bb/Mutagen/bb: Mutagens grant various boons to the drinker but always include a drawback that must be taken as well. If the drinker is immune to the drawback, or otherwise unable to take or be affected by the drawback, they do not gain any of the effects of the mutagen. A creature can only be under the effects of one mutagen at a time. If the creature drinks a second mutagen, the effect of the old one ends and is replaced by the new one unless the drinker makes a Fortitude save against the new mutagen. The drinker can choose to take this save even of the mutagen does not normally allow a save.',
					'/mm/ /ee/ <h4>Rocket</h4>',
			...
			[
				...
				'texts' => quick_array([
					...
					'Descriptor unique to advanced alchemy recipes are firework and soul-draining.',
					'Recipes also have the same list of descriptors as spells with the addition of the calling, charm, compulsion, figment, healing, polymorph, scrying, summoning, and teleportation descriptors. Recipes with one of these additional descriptors, while non-magical and not spells or spell-like abilities, are treated as being of the corresponding subschool.',
					...
					'/mm/ bb/Firework/bb: Firework recipes create an item based around highly flammable substances packed into a tight container. In addition to any normal effects of these recipes, these recipes produce very entertaining and impressive visual or auditory effect that may be harmlessly activated into the air to grant a circumstance bonus to Profession (pyrotechnics) equal to twice the level of recipe, with a minimum bonus of +1.',
					'/mm/ bb/Soul-Draining/bb: Soul-draining recipes require using the practicer\'s soul as a catalyst for the reaction. Most of these recipes are quite powerful but using ones soul this way is quite taxing. After successfully performing a soul-draining recipe, the practicer cannot perform another soul-draining recipe for 1 month.',
					'Alignment descriptors (chaotic, evil, good, and lawful) do not automatically indicate that performing the recipe or using the resulting item is an aligned act, only that aligned energies are used in the recipe. Some recipes with an alignment descriptor will indicate in their descriptions that an aligned action must be performed as part of the recipe, in which case performing the recipe is altogether an aligned action. Using items created by such recipes is not aligned action though creatures, particularly more devout ones, may have qaulms about using them or even outright refuse to use them anyway on principle.',
					'For characters with ties to a god or similar power, performing a recipe with an alignment descriptor opposite the alignment of that deity may be an anathema to that god.'
				])
			],
			[
				'title' => 'Level',
			...
			[
				'title' => 'Exceptional Reagents and Exceptional Catalysts',
				'spaced' => true,
				'texts' => quick_array([
					'Some recipes have Exceptional Reagents which are harder to acquire than some of the others. In order create an advanced alchemy recipe including exceptional reagents, the practicer must be able to acquire the listed reagents. Some exceptional reagents have an asociated cost. Unless specified otherwise, this cost is included in the cost of crafting the recipe, but abilities that reduce the cost of the recipe not including the cost of any exceptional reagents. As such, the cost of crafting a recipe cannot be reduced below the cost of the exceptional reagents.',
					'Exceptional Catalysts are similar except that they are not expended in the creation of the recipe. As they are not consumed, the price of exceptional catalysts is not included in the price of crafting the recipe. When purchasing an advanced alchemical item whose recipe includes an exceptional catalyst, the crafter may choose to increase the price of the item by somewhere between 1/10th and 1/100th of the cost of the catalyst.'
				])
			],
			[
				...
				'spaced' => true,
				'texts' => quick_array([
					'Activated, Applied, and Rocket recipes require a specific action to be activated, applied, or ignoted. This is generally 1 standard action.',
			...
			[
				...
				'texts' => quick_array([
					...
					'/mm/ Many durations are measured in rounds, minutes, hours, or other increments. When the time is up, the alchemical reactions end. If a recipe\'s duration is variable, the duration is rolled secretly so the practicer cannot doesn\'t know how long the recipe will last.',
					...
					'/mm/ /ee/ <h4>Tended</h4>',
					'/mm/ Some cauldron recipes persist so long as a practicer cannot continues to tend them. If the duration is listed as Tended its effects persist so long as the practicer cannot continues tending and stirring the mixture. Tending the mixture is a standard action that provokes attacks of opportunity unless the practicer cannot does so defensively. Tending a recipe defensively requires a concentration check equal to 15 plus twice the recipe level. If the practicer cannot fails this check they fail to tend the recipe. If a practicer cannot takes damage while performing the action to tend a recipe, they must make a concentration check equal to 10 plus the recipe level plus the amount of damage they took. A practicer cannot cannot tend a recipe while under an effect that would deny them their dexterity modifier. Another practicer cannot other than the one who began the recipe can attempt to tend a recipe but if a creature attempts to tend a recipe where they were not the last creature to attempt to tend the recipe, they must make a Craft (alchemy) check equal to 20 plus twice the level of recipe or else they fail to tend it. Any creature can attempt to tend a recipe but they can only succeed if the have at least one alchemy level or rank in Craft (alchemy). If they are not capable of creating the recipe they must also be able to receive verbal, written, or similar instruction from one who can in order to successfully tend the recipe. If the last creature who successfully tended the recipe does not successfully tend the recipe on their turn, it ends at the begining of their next turn if no other creature has successfully tended it before then.',
