<?php 
	...
	magicItemBlockAuto(
		...
		An ii/evocation rod/ii can be modified to function as any standard rod in addition its properties as a casting focus. This costs as much as creating a new rod of the corresponding type. Alternatively, they can be modified to strengthen damaging spells, adding a number of d6s of energy damage. This extra damage applies only to limited number of targets of your spells. The type of damage matches the rod\'s energy type. For a rod with a maximum affect spell level of 3rd, this damage is equal to 2d6 and it affects 1 target. For a rod with a maximum affect spell level of 6th, this damage is equal to 4d6 and it affects 2 targets. For a rod with a maximum affect spell level of 9th, this damage is equal to 6d6 and it affects 3 targets.',
		false,
