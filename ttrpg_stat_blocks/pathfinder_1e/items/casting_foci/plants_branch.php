...
<?php
	magicItemBlockAuto(
		...
		When used as a casting focus for a spell that affects or creates plant matter—such as ii/entangle/ii or ii/spike growth/ii—its magic manifests, causing numerous seeds of different types to suddenly grow from the branch, fall off, and bury themself into the ground nearby. They then spring up to create any vegetation or grass that the spell requires to function inside of the spell’s area of effect. The vegetation created by the branch grows regardless of the terrain, and lasts the full duration of the spell, allowing the user to cast plant-altering or plant-creating spells in deserts, badlands, and other harsh terrains.
