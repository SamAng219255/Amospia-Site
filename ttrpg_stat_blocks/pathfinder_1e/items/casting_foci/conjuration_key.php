<?php 
	...
	magicItemBlockAuto(
		...
		A ii/conjuring key/ii can be further enchanted to act similarly to a skeleton key. A ii/conjuring key/ii that can affect a maximum of 3rd level spells has a +5 Disable Device and adds 50 gp to the price of the keyt, a ii/conjuring key/ii that can affect a maximum of 6th level spells has a +10 Disable Device and adds 100 gp to the price of the key, and a ii/conjuring key/ii that can affect a maximum of 9th level spells has a +20 Disable Device and adds 200 gp to the price of the key. Further, a ii/conjuring key/ii negates the bonus to a lock\'s DC from the ii/arcane lock/ii spell and can be used to open a door without a lock that is affected by the ii/arcane lock/ii spell with a DC 10 Disable Device check using the key\'s bonus instead of your own.
		...
		bb/Upgrade/bb:
		bb/Requirements/bb Craft Wondrous Item, ii/knock/ii; bb/Cost/bb 25 gp (3rd), 50 gp (6th), 100 gp (9th)
		OR
