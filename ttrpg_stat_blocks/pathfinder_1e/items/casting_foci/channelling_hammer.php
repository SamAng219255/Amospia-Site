...
<?php
	magicItemBlockAuto(
		...
		8,
		'This hammer is shaped like a miniature warhammer which has been scaled down and adjusted slightly to be able to be wielded as a one handed weapon. The sides of the hammer depict holy symbols related to a god with an image of radiating light on the top. The handle is equally as ornate though with less specific patterns and a flatter design that can be gripped for long periods without difficulty.
