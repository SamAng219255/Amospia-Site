		...
		[
			[
				...
				'texts' => quick_array([
					...
					'Purchasing a service to have your image capture plates stabilized costs 10 gp (black and white) or 40 gp (three color) while performing the task yourself costs 5 gp (black and white) or 20 gp (three color) in addition to making the check. Purchasing a service to have finalized images produced from your negatives costs 15 gp (black and white) or 60 gp (three color) while performing the task yourself costs 7 gp and 5 silver (black and white) or 30 gp (three color) in addition to making the checks to properly project, potentially edit, and stabilize the image.',
