<?php 
	...
	raceBlockAuto(
		...
		It is most common for mandriff to be large sized and have the body of large sized creatures, in which case they bear a human-like torso sized like a normal Medium sized human.',// Physical Desc
		...
		'Mandriff are and strong and wise people but are not known for being the most clever or advanced. Large sized mandriff also face the issue of their size reducing their overall maneuverability.',// Ability Description
		[
			...
			'bb/Fast Speed/bb: Large mandriff have a base speed of 40 feet.',
			...
			'bb/Natual Attack/bb: Mandriff gain either a bite or gore natural attack. These are primary natural attacks that 1d8 points of damage.',
			...
			'bb/Quadruped/bb: Mandriff possess four legs and two arms, granting them a +4 racial bonus to CMD against trip attempts. In addition, mandriff use weapons and armor as if they were Medium sized (instead of Large).',
...
Standard (0 RP)
	+2 Con, +2 Wis, -2 Int
Linguist (1 RP)
	Start speaking Commonn and Mandriff.
	Can know any
