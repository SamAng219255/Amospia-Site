...
<?php
	raceBlockAuto(
		...
		"Redwoods are hardy and wise but slow and occasionally clumsy.",
		[
			"Large: Ancient Redwoods are Large creatures and gain a -1 penalty to their AC, a -1 penalty on attack rolls, a +1 size bonus on combat maneuver checks and to their Combat Maneuver Defense, and a -4 penalty on Stealth checks. Ancient Redwoods also gain a reach of 10 feet.",
			...
			"Knowledge of the Past: Ancient Redwoods often collect significant amounts of knowledge over their lifetimes though much is forgotten once it's no longer needed, some parts are remembered far longer. On character creation, pick two Knowledge skills. The Ancient Redwood gains a +2 racial bonus on both of these skills, and those skills are treated as class skills regardless of what class the Ancient Redwood actually takes.",
			"Focused Study: At 1st, 8th, and 16th level Ancient Redwoods gain the Skill Focus feat in a skill of their choice.",
