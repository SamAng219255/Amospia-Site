...
<?php
	raceBlockAutoSections(
		...
		"Gumodeuza form fairly tribal communities led by one or more elders wherein each member finds a place to dupport the community. They feel a close tie to nature and its creatures though also for the cycle of life and death and particularly for the cycle of predation. Gumodeuza seek to protect nature and especially its creatures but feel no qualms in hunting for food.",
		"Gumodeuza often have little contact with most other races though will regularly come in contact with druids and will aid them in their work. Many circles of druids will send their members to train in using their beast form with Gumodeuza communities.",
		"Gumodeuza vary wildly in alignment though many drift toward more neutral alignments. Most Gumodeuza follow the Green Faith or gods of nature and beasts.",
		"Gumodeuza will occasionally leave their communities and become adventurers though they have no particular inclination toward or against such lives. It is true however that their ability to take to form of mighty beasts becomes quite an asset.",
		"WIP",
		"WIP",
		[],
