<?php 
	...
	raceBlockAuto(
		...
		While less common than the large sized mandriff, medium size mandriff are not uncommon, having the head and body of a medium sized animal. Such mandriff bear a human-like torso that is smaller than that of human\'s, reduced in size to where it would fit a small sized creature.',// Physical Desc
		...
		[
			'Medium: Some mandriff are Medium creatures and have no bonuses or penalties due to their size.',
			'bb/Monstrous Humanoid/bb: Mandriff are monstrous humanoids.',
			'bb/Fast Speed/bb: Medium mandriff have a base speed of 40 feet.',
			...
			'bb/Natual Attack/bb: Mandriff gain either a bite or gore natural attack. These are primary natural attacks that 1d6 points of damage.',
			'Optionally, some mandriff may have two hoof attacks instead. These attacks are secondary attacks that deal 1d4 points of damage.',
			'bb/Quadruped/bb: Mandriff possess four legs and two arms, granting them a +4 racial bonus to CMD against trip attempts. In addition, mandriff use weapons and armor as if they were Small sized (instead of Medium).',
