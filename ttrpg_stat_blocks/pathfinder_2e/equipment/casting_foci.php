...
<?php
	...
	item2eBlockAuto(
		...
		[
			...
			'When not currently manifested, the spirit reamins in its current state with any conditions. When a primal caster performs their initial morning spell preperations, the spirit is restored to full health and loses any conditions and other effects.',
			'???-Upgrade'
		],
		[
			[
