...
?>
<title>Piccilli</title>
<?php
	race2eBlock(
		'Piccilli',
		'Humanoid',
		'Piccilli are humanoids that hail from the high bows and have been gifted the form of birds from the goddess Fluut. One of the three gods of the high bows of the mighty tree Geldrine. Which occupies the entirety of their home plane. Its branches support all manner of life and it is said that despite how far you travel you will not find their end nor trunk, not that many tested that claim. Though portals to the trunk can be found thoughout the inhabited regions of the branches, created either by gods or by powerful druids to unite the people of trunk and bows. The roots of the mighty Geldrine extend far, far below and are anchored in other planes of existence. Through these roots the people of the bows and trunk are able to perfect gateways to other realms and often trade with other planes.',
		[
		...
		'Piccilli live fairly peaceful lives in the upper bows building house by shaping the branches either magically or with patience and effort or by finding a suitable location to construct a house out of branches found elsewhere. From these dwelling they look down at the middle and lower bows often darting out to catch some prey. Their society has little organization and often plays by the rule "If you don\'t bother me I won\'t bother you," though respect is always paid to the priestesses and priests of the gods and especially those of Fluut.',
		'Piccilli\'s passive attitudes generally tend them towards more neutral alignment though it is in no way uncommon to see extreme ones. Most Piccilli primarily revere Fluut but many also follow the decrees of the gods of the high bows and almost all respect the green faith.',
		...
		'Common
		Avian
		Additional languages equal to your Intelligence modifier (if it\'s positive). Choose from Auran, Celestial, Elven, Mathine, Muuyine, Sylvan, Wernan, and any other languages to which you have access (such as the languages prevalent in your region).',
			[
				[
