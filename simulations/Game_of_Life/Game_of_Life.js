...
function activate(event) {
	...
	y=Math.floor((event.y-(canvas.offsetTop+Math.round(screen.height/20)-document.getElementById("content").scrollTop-document.getElementById("center").scrollTop-2))/UCAsize);
	if(foo[x][y]) {
		foo[x][y]=false;
	}
	else {
